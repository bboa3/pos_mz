	...
	<div class="phone-input-container">
		...
		<div class="flex">
			...
			<input
				...
				:disabled="disabled"
				:required="required"
				class="flex-1 px-3 py-2 border border-l-0 border-gray-300 rounded-r-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
				:class="{
